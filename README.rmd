...
```{r social_network, echo=FALSE, fig.align="center", fig.width=5, fig.height=8, dpi = 300}
set.seed(20190605)
...
![no caption](README_files/figure-markdown_github/social_network-1.png){width=800px}
